...
# Выйти при использовании неопределенной переменной
set -u

# Показать команды при выполнении (debugging)
set -x
...
- [ShellCheck](https://www.shellcheck.net/) — анализатор bash-скриптов
