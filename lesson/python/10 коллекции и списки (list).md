...
- [Списки и изменяемость](#1-коллекции-и-изменяемость)
- [Создание списков](#3-создание-списков)
- [Индексация](#4-индексация-списков)
- [Срезы](#5-срезы-списков-slices)
- [Изменение списка](#6-изменение-списка-mutable)
- [Операции со списками](#7-операции-со-списками)
- [`list()`](#8-преобразование-в-список-list)
