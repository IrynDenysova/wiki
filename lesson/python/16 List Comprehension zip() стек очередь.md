...
- [List comprehension (списковое включение)](#1-list-comprehension-списковое-включение)
- [List comprehension с условием `if` (фильтрация)](#2-list-comprehension-с-условием-if-фильтрация)
- [List comprehension с `if ... else` (преобразование каждог...](#3-list-comprehension-с-if-else-преобразование-каждого-элемента)
- [Вложенное `if ... else` (несколько уровней условий)](#4-вложенное-if-else-несколько-уровней-условий)
- [List comprehension с вложенным циклом (nested loops)](#5-list-comprehension-с-вложенным-циклом-nested-loops)
