...
- [Множество (Set): что это](#1-множество-set-что-это)
- [Создание множества](#2-создание-множества)
- [`hash()` и хешируемость](#3-hash-и-хешируемость)
- [Как множество хранится в памяти (идея)](#4-как-множество-хранится-в-памяти-идея)
- [Преобразование в множество: `set(iterable)`](#5-преобразование-в-множество-setiterable)
- [Методы добавления/удаления элементов](#6-методы-добавленияудаления-элементов)
