...
- [`dict.fromkeys(iterable, value=None)`](#1-dictfromkeysiterable-valuenone)
- [`dict.get(key, default=None)`](#2-dictgetkey-defaultnone)
- [`dict.setdefault(key, default=None)`](#3-dictsetdefaultkey-defaultnone)
- [`keys()`, `values()`, `items()` = view-объекты](#4-keys-values-items-view-объекты)
- [Итерация по словарю](#5-итерация-по-словарю)
