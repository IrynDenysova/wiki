...
- [Передача функций в качестве аргументов](#1-передача-функций-в-качестве-аргументов)
- [Lambda-функции](#2-lambda-функции)
- [Парадигмы программирования (кратко)](#3-парадигмы-программирования-кратко)
- [Функциональное программирование — ключевые идеи](#4-функциональное-программирование-ключевые-идеи)
- [Функции высшего порядка (Higher-Order Functions)](#5-функции-высшего-порядка-higher-order-functions)
- [`map`, `filter`, `reduce`](#6-map-filter-reduce)
