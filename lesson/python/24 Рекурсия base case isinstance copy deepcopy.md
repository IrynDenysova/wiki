...
- [Что такое рекурсия](#1-что-такое-рекурсия)
- [Примеры рекурсивных функций](#2-примеры-рекурсивных-функций)
- [Хвостовая рекурсия (tail recursion)](#3-хвостовая-рекурсия-tail-recursion)
- [Разный порядок выполнения (до/после рекурсивного вызова)](#4-разный-порядок-выполнения-допосле-рекурсивного-вызова)
- [Рекурсия или итерация?](#5-рекурсия-или-итерация)
