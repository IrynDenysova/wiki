...
- [Что такое исключения](#1-что-такое-исключения)
- [Как Python реагирует на ошибку](#2-как-python-реагирует-на-ошибку)
- [Иерархия исключений (важно понимать)](#3-иерархия-исключений-важно-понимать)
- [Базовая конструкция `try-except`](#4-базовая-конструкция-try-except)
- [Как Python выбирает обработчик `except`](#5-как-python-выбирает-обработчик-except)
- [Обработка нескольких исключений в одном блоке](#6-обработка-нескольких-исключений-в-одном-блоке)
