...
- [Файловая система и структура каталогов](#1-файловая-система-и-структура-каталогов)
- [Абсолютные и относительные пути](#2-абсолютные-и-относительные-пути)
- [Специальные обозначения в путях](#3-специальные-обозначения-в-путях)
- [Модуль `os`: работа с файловой системой](#4-модуль-os-работа-с-файловой-системой)
- [Работа с путями: `os.path`](#5-работа-с-путями-ospath)
