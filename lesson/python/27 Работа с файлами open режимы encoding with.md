...
- [Зачем уметь работать с файлами](#1-зачем-уметь-работать-с-файлами)
- [Типы файлов](#2-типы-файлов)
- [`open()` — как открыть файл](#3-open-как-открыть-файл)
- [Режимы работы с файлами (таблица)](#4-режимы-работы-с-файлами-таблица)
- [`encoding` — почему важно](#5-encoding-почему-важно)
- [Закрытие файла: `close()`](#6-закрытие-файла-close)
