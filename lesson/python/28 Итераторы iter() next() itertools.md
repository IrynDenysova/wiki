...
- [[#7) `itertools` — полезные итераторные инструменты]](#7-itertools-—-полезные-итераторные-инструменты)
- [[#8) Генераторное выражение (generator expression)]](#8-генераторное-выражение-generator-expression)
- [[#Задания 1]](#задания-1)
- [[#Задания 2]](#задания-2)
- [[#ДЗ 1) Планировщик на неделю (бесконечный вывод по Enter)]](#дз-1-планировщик-на-неделю-бесконечный-вывод-по-enter)
