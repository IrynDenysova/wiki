...
- [JSON — что это](#1-json-что-это)
- [Модуль `json`: сериализация и десериализация](#2-модуль-json-сериализация-и-десериализация)
- [Сравнение типов Python и JSON](#3-сравнение-типов-python-и-json)
- [Форматирование JSON](#4-форматирование-json)
- [`JSONDecodeError`: что это и почему возникает](#5-jsondecodeerror-что-это-и-почему-возникает)
