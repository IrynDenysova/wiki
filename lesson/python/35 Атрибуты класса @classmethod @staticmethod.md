...
- [Поля класса (атрибуты класса)](#1-поля-класса-атрибуты-класса)
- [Доступ к полям класса и изменение](#2-доступ-к-полям-класса-и-изменение)
- [Магическое поле `__dict__`](#3-магическое-поле-dict)
- [Поля объекта по умолчанию](#4-поля-объекта-по-умолчанию)
- [Классовые методы: `@classmethod`](#5-классовые-методы-classmethod)
- [Статические методы: `@staticmethod`](#6-статические-методы-staticmethod)
