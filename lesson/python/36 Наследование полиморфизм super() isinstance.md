...
- [[#1) Принципы ООП (быстрое повторение)]](#1-принципы-ооп-быстрое-повторение)
- [[#2) Наследование: базовые понятия и синтаксис]](#2-наследование-базовые-понятия-и-синтаксис)
- [[#3) Полиморфизм: переопределение метода (overriding)]](#3-полиморфизм-переопределение-метода-overriding)
- [[#4) `super()` — правильный вызов методов родителя]](#4-super-—-правильный-вызов-методов-родителя)
- [[#5) `super()` в многоуровневом наследовании]](#5-super-в-многоуровневом-наследовании)
- [[#6) `super()` в обычных методах (расширяем, а не заменяем)]](#6-super-в-обычных-методах-расширяем-а-не-заменяем)
- [[#7) Наследование от `object`]](#7-наследование-от-object)
- [[#8) `isinstance()` и `issubclass()`]](#8-isinstance-и-issubclass)
- [[#10.1 Класс `Employee`]](#101-класс-employee)
- [[#10.2 Класс `Developer` (наследник) + переопределение `work()` + `super()`]](#102-класс-developer-наследник-переопределение-work-super)
- [[#11.1 Класс `Person`]](#111-класс-person)
- [[#11.2 Класс `Student(Person)` + `course` + расширенный `introduce()`]](#112-класс-studentperson-course-расширенный-introduce)
- [[#11.3 Класс `Teacher(Person)` + `subject` + свой `introduce()`]](#113-класс-teacherperson-subject-свой-introduce)
- [[#11.4 Список людей (Student + Teacher) и полиморфизм]](#114-список-людей-student-teacher-и-полиморфизм)
