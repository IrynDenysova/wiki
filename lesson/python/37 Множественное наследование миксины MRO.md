...
- [Множественное наследование](#1-множественное-наследование)
- [`hasattr()` — проверка наличия атрибута](#2-hasattr-проверка-наличия-атрибута)
- [Миксины (Mixin)](#3-миксины-mixin)
- [Порядок поиска методов + “проблема ромба”](#4-порядок-поиска-методов-проблема-ромба)
- [MRO (Method Resolution Order)](#5-mro-method-resolution-order)
- [`super()` в множественном наследовании](#6-super-в-множественном-наследовании)
