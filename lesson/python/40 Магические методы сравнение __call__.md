...
- [Методы сравнения (comparison dunder methods)](#1-методы-сравнения-comparison-dunder-methods)
- [`functools.total_ordering`](#2-functoolstotalordering)
- [Индексация и доступ к элементам (объект как коллекция)](#3-индексация-и-доступ-к-элементам-объект-как-коллекция)
- [Арифметические методы](#4-арифметические-методы)
- [`__bool__`: поведение в `if/while`](#5-bool-поведение-в-ifwhile)
- [`__call__`: делаем объект вызываемым как функцию](#6-call-делаем-объект-вызываемым-как-функцию)
