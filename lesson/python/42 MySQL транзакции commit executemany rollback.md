...
- [План урока](#0-план-урока)
- [Подключение без указания базы данных](#1-подключение-без-указания-базы-данных)
- [Выбор базы данных после подключения: команда `USE`](#2-выбор-базы-данных-после-подключения-команда-use)
- [DictCursor — результаты как словари](#3-dictcursor-результаты-как-словари)
- [`commit()` — фиксация изменений](#4-commit-фиксация-изменений)
- [Подключение с правами на изменения (создание БД/таблиц)](#5-подключение-с-правами-на-изменения-создание-бдтаблиц)
