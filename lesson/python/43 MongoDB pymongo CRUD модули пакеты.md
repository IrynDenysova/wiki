...
- [[#1) MongoDB и Python: база и подготовка]](#1-mongodb-и-python-база-и-подготовка)
- [[#2) Подключение к серверу MongoDB]](#2-подключение-к-серверу-mongodb)
- [[#3) Добавление данных (Create)]](#3-добавление-данных-create)
- [[#4) Чтение данных (Read): find_one / find + курсор]](#4-чтение-данных-read-findone-find-курсор)
- [[#5) Проекция полей (выбор нужных полей)]](#5-проекция-полей-выбор-нужных-полей)
- [[#6) Обновление данных (Update): update_one / update_many]](#6-обновление-данных-update-updateone-updatemany)
- [[#7) Удаление данных (Delete): delete_one / delete_many]](#7-удаление-данных-delete-deleteone-deletemany)
- [[#8) Обработка ошибок (try/except) в pymongo]](#8-обработка-ошибок-tryexcept-в-pymongo)
- [[#Задача 1: найти заказы с amount < 10]](#задача-1-найти-заказы-с-amount-10)
- [[#Задача 2: сохранить найденное в orders_lesson_43]](#задача-2-сохранить-найденное-в-orderslesson43)
- [[#9) Модули в Python]](#9-модули-в-python)
- [[#10) __pycache__ и .pyc]](#10-pycache-и-pyc)
- [[#11) Пакеты и папки (packages)]](#11-пакеты-и-папки-packages)
- [[#ДЗ 1: добавить товары]](#дз-1-добавить-товары)
- [[#ДЗ 2: увеличить цены на 20% и вывести всё]](#дз-2-увеличить-цены-на-20-и-вывести-всё)
