...
- [`if`](#2-if-синтаксис-и-базовые-правила)
- [`elif`](#4-elif-несколько-альтернатив)
- [`else`](#5-else-когда-ничего-не-подошло)
- [Тернарный оператор](#10-тернарный-оператор-короткий-if-else)
- [`match-case`](#11-match-case-python-310)
- [Вложенные условия](#8-вложенные-условия-nested-if)
