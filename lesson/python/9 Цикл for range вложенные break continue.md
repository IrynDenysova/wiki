...
- [[#2) Итерируемый объект (iterable)]](#2-итерируемый-объект-iterable)
- [[#3) Цикл `for`: идея и синтаксис]](#3-цикл-for-идея-и-синтаксис)
- [[#4) `range()` — генератор диапазона чисел для `for`]](#4-range-—-генератор-диапазона-чисел-для-for)
- [[#5) `break`, `continue`, `else` в цикле `for`]](#5-break-continue-else-в-цикле-for)
- [[#6) Вложенные циклы (nested loops)]](#6-вложенные-циклы-nested-loops)
- [[#7) Вложенные циклы `while + for` (комбинация)]](#7-вложенные-циклы-while-for-комбинация)
- [[#8) Контрольные мини-вопросы (быстрые ответы)]](#8-контрольные-мини-вопросы-быстрые-ответы)
- [[#9) Практическая работа (готовые решения)]](#9-практическая-работа-готовые-решения)
- [[#10) Домашнее задание (решения/шаблоны)]](#10-домашнее-задание-решенияшаблоны)
